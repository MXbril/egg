      ...
      <header className="w-full min-h-[150px] bg-[#ff3b3c] p-[20px 20px 0 20px] flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <li id="cart" className="w-[50px] h-[50px] list-none">
              <Link className="w-[50px] h-[50px]" to="/login">
              <FontAwesomeIcon className="w-[25px] h-[25px]  p-[10px]"  icon={faUser} size="2x" color="white"/>     
              </Link>
            </li>
          </ul>
        </div>
        <nav
          ...
          id="navbar"
        >
          <NavButton title="Ofertas" link="/ofertas" />
          <NavButton title="Cómo comprar" link="/como-comprar" />
          <NavButton title="Costos y tarifas" link="/costo-tarifa" />
          <NavButton title="Mis pedidos" link="/pedidos" />
          <NavButton title="Garantía" link="/garantia" />
        </nav>
      </header>
    </>
  );
