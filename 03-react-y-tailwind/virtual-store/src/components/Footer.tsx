  ...
  return (
    <>
      <footer className="w-full min-h-[250px] bg-[#7525a7] flex flex-col items-center">
        <div id="footer" className="w-full flex-col flex justify-between items-center p-[10px]
        ...
        <div className="w-full lg:w-[1024px] border-t-[1px] border-t-[#ba53fb] text-center text-white font-bold py[30px] px0 box-border">
          Curso de React + Tailwind 2024
        </div>
      </footer>
    </>
  );
